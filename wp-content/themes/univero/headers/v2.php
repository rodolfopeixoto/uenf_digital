<header id="ninzio-header" class="site-header ninzio-header header-v2 hidden-sm hidden-xs <?php echo univero_get_config('enable_header_mobile_1024', false) ? 'hidden-1024' : ''; ?>" role="banner">
