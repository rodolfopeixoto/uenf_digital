...
class Univero_Single_Image extends Ninzio_Widget {
    public function __construct() {
        parent::__construct(
            'ninzio_single_image',
            esc_html__('Ninzio Single Image Widget', 'univero'),
            array( 'description' => esc_html__( 'Show single image', 'univero' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e( 'Description:', 'univero' ); ?></label>
        ...
        <label for="<?php echo esc_attr($this->get_field_id( 'single_image' )); ?>"><?php esc_html_e( 'Image:', 'univero' ); ?></label>
        <div class="screenshot">
            <?php if ( $instance['single_image'] ) { ?>
                <img src="<?php echo esc_url($instance['single_image']); ?>" alt="<?php esc_attr_e('Image', 'univero'); ?>"/>
            <?php } ?>
        </div>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'alt' )); ?>"><?php esc_html_e( 'Alt:', 'univero' ); ?></label>
...
univero_reg_widget( 'Univero_Single_Image' );