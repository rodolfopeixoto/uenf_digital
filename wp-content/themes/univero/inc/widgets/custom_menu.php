...
class Univero_Custom_Menu extends Ninzio_Widget {
    public function __construct() {
        parent::__construct(
            'ninzio_custom_menu',
            esc_html__('Ninzio Custom Menu Widget', 'univero'),
            array( 'description' => esc_html__( 'Show custom menu', 'univero' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>">
                <?php echo esc_html__('Menu:', 'univero' ); ?>
            </label>
            <br>
...
univero_reg_widget( 'Univero_Custom_Menu' );